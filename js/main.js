...
document.getElementById("btnLimpiar").addEventListener("click", () => {
  ...
  // Oculta todos los mensajes de error individuales
  document.querySelectorAll(".alert-danger").forEach(div => {
    div.style.display = "none";
    div.textContent = ""; // limpia texto por si quedó algo
  });

  // Oculta alertas globales
  alertaError.style.display = "none";
  alertaExito.style.display = "none";

  // Oculta el indicador de fortaleza de contraseña
